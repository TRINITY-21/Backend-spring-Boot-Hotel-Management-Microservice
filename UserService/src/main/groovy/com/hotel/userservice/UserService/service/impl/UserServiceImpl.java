package com.hotel.userservice.UserService.service.impl;
...
import com.hotel.userservice.UserService.mapper.UserMapper;
...
import com.hotel.userservice.UserService.service.AwsS3Service;
import com.hotel.userservice.UserService.service.MailService;
import com.hotel.userservice.UserService.service.interfaces.IUserService;
import com.hotel.userservice.UserService.utils.JWTUtils;
...
public class UserServiceImpl implements IUserService {
                                 ...
                                 String phone, String email, UserRole userRole)
    {
        ...
        System.out.println("Incoming userRole: " + userRole);
        ...
        try{
            ...
            System.out.println(userDto + "user DOT");
            ...
            attributes.put("firstName", user.getDisplayName());
    ...
    public ResponseData getAllUsers() {
        ...
        try{
            ...
            System.out.println(userList + "user DOT");
...
//
    ...
    @Override
    public ResponseData updateUser(Long userId,MultipartFile profileImage,String username, String email, String city, String address,String phone, UserRole userRole) {
        ...
        try {
            ...
            if (userRole != null) user.setRole(String.valueOf(userRole));
